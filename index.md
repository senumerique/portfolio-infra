...
Ce portfolio présente une sélection de **projets techniques majeurs** réalisés en environnement professionnel.
...
**Cloud :** Azure / AWS  
**Automatisation :** Bash, PowerShell, Ansible, Terraform  
**Conteneurs :** Docker  
**Supervision :** Zabbix, Prometheus, Grafana  
**Outils :** Git, GitLab CI
...
## 📈 Autres réalisations
- Gestion d’incidents critiques (niveau 3)
- Participation aux choix d’architecture
- Amélioration de la supervision et des alertes
- Renforcement de la sécurité systèmes
